...
function fall() {
  for (let p = 1; p <= i; p++) {
    ...
    let direction = Schneeflocken_a[p - 1] > 2 ? 1 : -1;
    fallschnee.style.left = (fallschnee.offsetLeft + direction * (Math.abs(Schneeflocken_a[p - 1]) - 1)) + "px";
